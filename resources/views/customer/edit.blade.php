                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-col gap-4 mt-5">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="number" class="border-2 rounded-md w-full py-1 px-2 bg-white border-gray-500/30 focus:border-gray-500/50 focus:outline-none {{ $errors->has('wallet_balance') ? 'border-red-500' : '' }}" id="wallet_balance" name="wallet_balance" value="{{ old('wallet_balance', $customer['balance']) }}">
