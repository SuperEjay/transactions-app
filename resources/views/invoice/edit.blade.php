                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-4 mt-5">
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" class="border-2 rounded-md w-full py-1 px-2 bg-white border-gray-500/30 focus:border-gray-500/50 focus:outline-none {{ $errors->has('reference_number') ? 'border-red-500' : '' }}" id="reference_number" name="reference_number" value="{{ old('reference_number', $invoice['reference_number']) }}">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="number" class="border-2 rounded-md w-full py-1 px-2 bg-white border-gray-500/30 focus:border-gray-500/50 focus:outline-none {{ $errors->has('amount') ? 'border-red-500' : '' }}" id="amount" name="amount" value="{{ old('amount', $invoice['amount']) }}">
